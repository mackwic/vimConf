...
""" Use the damn hjkl keys -- NOPE ! wickha_t
""nnoremap <up> <nop>
""nnoremap <down> <nop>
""nnoremap <left> <nop>
""nnoremap <right> <nop>
...
au BufRead,BufNewFile *.til set filetype=tiger
au BufRead,BufNewFile *.tix set filetype=tiger
au BufRead,BufNewFile *.ttu set filetype=tiger
" }}}
" Vagrant {{{
